 ...
 */
if (!class_exists('bagpo_AdminPage')){
  class bagpo_AdminPage {
    /**
...
if (!class_exists('bagpo_TopPage')){
  class bagpo_TopPage extends bagpo_AdminPage {
    /**
...
if (!class_exists('bagpo_SubPage')){
  class bagpo_SubPage extends bagpo_AdminPage{
    /**
     * Builds a new Top-Level-Menu
     *
     * Possible keys within $args:
    ...
    public function __construct($top, $args) {
      if(is_object($top)) {
        ...
        switch($top) {
          ...
          case 'baqa_q':
            $this->top = 'edit.php?post_type=baqa_q';
            break;
